...
module.exports = {
    ...
    'facebookAuth' : {
        ...
        'callbackURL'   : 'http://ec2-54-255-167-119.ap-southeast-1.compute.amazonaws.com:8080/auth/facebook/callback'
    },

    'twitterAuth' : {
        'consumerKey'       : 'FVe4QJYBmYTNhlGMkEwYeWwqd',
        'consumerSecret'    : 'tFI7glsQknGuC1iWbtUm4GqvMNs6rkRrz84PfYk0dSB5yiN08o',
        'callbackURL'       : 'http://ec2-54-255-167-119.ap-southeast-1.compute.amazonaws.com:8080/auth/twitter/callback'
    },

    'googleAuth' : {
        'clientID'      : '491509167174-c5dbi2r8cro4u11d22ln97i9l61bvgj7.apps.googleusercontent.com',
        'clientSecret'  : 'q8hgsGRa34pej_yYhGaT7qdS',
        'callbackURL'   : 'http://ec2-54-255-167-119.ap-southeast-1.compute.amazonaws.com:8080/auth/google/callback'
    }
